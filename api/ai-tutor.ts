  ...
  try {
    ...
    if (!apiKey) {
      return res.status(500).json({ 
        error: "GEMINI_API_KEY environment variable is not configured. Please add your key in the Settings or Environment Variables." 
      });
    }
    ...
    // Unpack potential accidental JSON outputs
